...
export function withdraw(http: HttpClient, rootUrl: string, params: Withdraw$Params, context?: HttpContext): Observable<StrictHttpResponse<string>> {
...
withdraw.PATH = '/bank/transaction/withdraw';
